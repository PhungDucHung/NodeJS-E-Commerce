        ...
        <div className="h-[103px] w-full bg-main flex items-center justify-center">
            <div className='w-main flex items-center justify-between'>
               ...
               <div className='flex-1 flex items-center'>
                    <input className='p-4 rounded-1-full rounded-l-full flex-1 bg-[#F04646] outline-none text-gray-100 placeholder:text-sm placeholder:text-gray-100 placeholder:italic placeholder:opacity-40' type='text'
